...
import logging
log = logging.getLogger('blaiog.config')
...
class Config(object):
    ...
    def __init__(self, configfile="/etc/blaiog/blaiog.yaml"):
        if os.path.isfile(configfile):
            log.debug("Got file {}".format(configfile))
...
def writeDefaults(configfile):
    ...
    with open(configfile, 'w') as file:
        header = """# blaiog configuration
# ----------------------
# These are the default settings for blaiog.
